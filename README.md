...
<img src="assets/demo.gif?v=4" alt="Demo — zooming from the real OpenStreetMap map into Manhattan, Paris, Barcelona and Rome, where the streets become a Pac-Man maze" width="100%">
